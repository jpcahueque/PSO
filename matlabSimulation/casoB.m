function [Utot] = casoB(gridsize,step,rounding,zeta,eta,dstar,Qi,c_g,l_g,c_o,l_o,choset,behaviour,showAPF)
%% Caso a resolver B
...
title('Caso B', 'Interpreter', 'latex', 'Fontsize', 16)
%pause(5);
figure(1);hold on
contour(x,y,Utot);
%grid minor;
